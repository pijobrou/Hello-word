# Brand profile — BVY Accounting & Tax Services Inc.

Chaque livrable lit ce fichier en premier. Corriger ici, jamais en aval (Update-Back Rule).
Tag : **[S]** = Stone (fait vérifié, source citée) · **[O]** = Opinion (affirmation non vérifiée → question de recherche).
...
## Audience
- ★ **Primary audience (demande du client) :**
  1. **Particuliers** et travailleurs autonomes de la Nouvelle-Beauce : faire leur déclaration T1/TP-1 sans stress, avant le 30 avril.
  2. **PME et entreprises incorporées locales** (1–20 employés) : livres à jour, TPS/TVQ et états financiers + T2 à temps.
- **Secondary :** entrepreneurs étrangers francophones qui veulent s'établir au Québec (offre phare actuelle du site).
- **Personas on file :** voir PLAN.md § 3.

## Voice (1–10) — proposition v1, à valider
...
## Channels
- **Active :** site web ; page Facebook (adresse ontarienne) [S] ; fiches annuaires anciennes (PagesJaunes/Yellowpages, Cylex, Infobel — adresses Scarborough ON, téléphones 647-778-7627 et 438-831-1554) [S]
- **Google Business Profile :** non vérifiable d'ici [O — à confirmer]
- **Owned lists :** inconnues [O]

## Goals and measurement
- ★ **Primary goal (proposé, à valider) :** 25 demandes de consultation qualifiées d'ici le 31 janvier 2027, puis 60 sur la saison d'impôt (1er fév. – 30 avril 2027). [O — objectif proposé, sans historique]
- **Measurement stack :** **aucun** outil d'analyse détecté sur le site (ni GA4, ni GTM, ni pixel) [S]

## Competitors
- **Set chosen by :** `competitor-analysis` du 2026-09-24 → `seo-audit-campagne/2026-09-24/02-concurrents.md`.
- Direct : Blanchette Vachon (BVA), Raymond Chabot Grant Thornton Sainte-Marie, KLAC Gestion, Impôts et Comptabilité A.D., Comptable en ligne Québec. International : GFCMA Québec.

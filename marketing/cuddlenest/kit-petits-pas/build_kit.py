...
C = {
 "fr": {
  ...
  "end": "Des questions ? Écrivez-nous : [votre courriel] · cuddlenest.ca<br/>Petits pas, grandes étapes. 💛".replace(" 💛", ""),
 ...
 "en": {
  ...
  "end": "Questions? Email us: [your email] · cuddlenest.ca<br/>Small steps, big milestones.",

...
|---|---|---|
| Mise en place de la marque | `../../brand-profile.md` (v2 : nouveau domaine, faits Stone/Opinion) | ✅ fait |
| Audit du site + bloquants | PLAN.md § 1–2 | ✅ fait, puis refait sur cuddlenest.ca le soir même : **produit indisponible (B0)**, prix modifiés |
...
| Validation client (budget, prix, objectif, bloquants) | — | ⏸ **en attente de toi** |
| Analyse concurrentielle | — | ⬜ pas lancée (recommandée) |
| Mise en ligne | — | ⬜ nécessite ton « go » écrit + comptes connectés |
